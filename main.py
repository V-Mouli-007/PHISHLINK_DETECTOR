...
<head>
    ...
    <title>PHISHLINK_DETECTOR</title>
...
<div class="container">
    ...
    <footer>Made By V.Mouli & Bhavya Narala &nbsp;|&nbsp; PHISHLINK_DETECTOR v2.0</footer>
</div>
...
def print_cli_banner():
    print(Style.BRIGHT)
    banner_text = pyfiglet.figlet_format("PHISHLINK_DETECTOR", font="slant")
    print(f"{Fore.CYAN}{banner_text}")
    print(f"{Fore.YELLOW}Made By V.Mouli & Bhavya Narala — v2.0 (Web Search Edition)\n{Style.RESET_ALL}")
